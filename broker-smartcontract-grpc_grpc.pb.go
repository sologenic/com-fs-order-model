...
const (
	...
	BrokerSmartContractService_GetAndLockUnprocessedBSCOrder_FullMethodName  = "/order.BrokerSmartContractService/GetAndLockUnprocessedBSCOrder"
	BrokerSmartContractService_SetBSCOrderProcessed_FullMethodName           = "/order.BrokerSmartContractService/SetBSCOrderProcessed"
)
...
func (c *brokerSmartContractServiceClient) GetAndLockUnprocessedBSCOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Order, error) {
	out := new(Order)
	err := c.cc.Invoke(ctx, BrokerSmartContractService_GetAndLockUnprocessedBSCOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *brokerSmartContractServiceClient) SetBSCOrderProcessed(ctx context.Context, in *Order, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BrokerSmartContractService_SetBSCOrderProcessed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BrokerSmartContractService_GetAndLockUnprocessedBSCOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrokerSmartContractService_GetAndLockUnprocessedBSCOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BrokerSmartContractService_SetBSCOrderProcessed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrokerSmartContractService_SetBSCOrderProcessed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
