...
(function (AssetClass) {
    AssetClass[AssetClass["NOT_USED_ASSET_CLASS"] = 0] = "NOT_USED_ASSET_CLASS";
    AssetClass[AssetClass["US_EQUITY"] = 1] = "US_EQUITY";
    AssetClass[AssetClass["CRYPTO"] = 2] = "CRYPTO";
    AssetClass[AssetClass["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(AssetClass || (AssetClass = {}));
export function assetClassFromJSON(object) {
    switch (object) {
        case 0:
        case "NOT_USED_ASSET_CLASS":
            return AssetClass.NOT_USED_ASSET_CLASS;
        case 1:
        case "US_EQUITY":
...
export function assetClassToJSON(object) {
    switch (object) {
        case AssetClass.NOT_USED_ASSET_CLASS:
            return "NOT_USED_ASSET_CLASS";
...
(function (TimeInForce) {
    ...
    TimeInForce[TimeInForce["GTT"] = 3] = "GTT";
    /** OPG - TODO: the below types will be implemented in the future */
    TimeInForce[TimeInForce["OPG"] = 4] = "OPG";
    TimeInForce[TimeInForce["CLS"] = 5] = "CLS";
    TimeInForce[TimeInForce["IOC"] = 6] = "IOC";
    TimeInForce[TimeInForce["FOK"] = 7] = "FOK";
...
(function (TradeType) {
    ...
    TradeType[TradeType["OCO"] = 7] = "OCO";
    /** OTO - One-Triggers-Other */
    TradeType[TradeType["OTO"] = 8] = "OTO";
...
export function tradeTypeFromJSON(object) {
    switch (object) {
        ...
        case 7:
        case "OCO":
            return TradeType.OCO;
        case 8:
        case "OTO":
            return TradeType.OTO;
        case 9:
        case "TRAILING_STOP":
...
(function (OrderClass) {
    ...
    OrderClass[OrderClass["ORDER_CLASS_OCO"] = 3] = "ORDER_CLASS_OCO";
    /** ORDER_CLASS_OTO - One-Triggers-Other */
    OrderClass[OrderClass["ORDER_CLASS_OTO"] = 4] = "ORDER_CLASS_OTO";
...
export function orderClassFromJSON(object) {
    switch (object) {
        ...
        case 3:
        case "ORDER_CLASS_OCO":
            return OrderClass.ORDER_CLASS_OCO;
        case 4:
        case "ORDER_CLASS_OTO":
            return OrderClass.ORDER_CLASS_OTO;
        case -1:
        case "UNRECOGNIZED":
        default:
...
export function orderClassToJSON(object) {
    switch (object) {
        ...
        case OrderClass.ORDER_CLASS_OCO:
            return "ORDER_CLASS_OCO";
        case OrderClass.ORDER_CLASS_OTO:
            return "ORDER_CLASS_OTO";
...
(function (BrokerOrderStatus) {
    BrokerOrderStatus[BrokerOrderStatus["NOT_USED_ALPACA_ORDER_STATUS"] = 0] = "NOT_USED_ALPACA_ORDER_STATUS";
...
export function brokerOrderStatusFromJSON(object) {
    switch (object) {
        case 0:
        case "NOT_USED_ALPACA_ORDER_STATUS":
            return BrokerOrderStatus.NOT_USED_ALPACA_ORDER_STATUS;
        case 1:
        case "PENDING_NEW":
...
export function brokerOrderStatusToJSON(object) {
    switch (object) {
        case BrokerOrderStatus.NOT_USED_ALPACA_ORDER_STATUS:
            return "NOT_USED_ALPACA_ORDER_STATUS";
...
export const BrokerOrderDetails = {
    ...
    fromJSON(object) {
        return {
            ...
            AssetClass: isSet(object.AssetClass) ? assetClassFromJSON(object.AssetClass) : 0,
