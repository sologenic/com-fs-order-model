...
(function (InternalOrderState) {
    InternalOrderState[InternalOrderState["NOT_USED_INTERNAL_ORDER_STATE"] = 0] = "NOT_USED_INTERNAL_ORDER_STATE";
...
export function internalOrderStateFromJSON(object) {
    switch (object) {
        case 0:
        case "NOT_USED_INTERNAL_ORDER_STATE":
            return InternalOrderState.NOT_USED_INTERNAL_ORDER_STATE;
        case 1:
...
export function internalOrderStateToJSON(object) {
    switch (object) {
        case InternalOrderState.NOT_USED_INTERNAL_ORDER_STATE:
            return "NOT_USED_INTERNAL_ORDER_STATE";
...
(function (OrderDetailType) {
    OrderDetailType[OrderDetailType["NOT_USED_ORDER_DETAIL_TYPE"] = 0] = "NOT_USED_ORDER_DETAIL_TYPE";
...
export function orderDetailTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "NOT_USED_ORDER_DETAIL_TYPE":
            return OrderDetailType.NOT_USED_ORDER_DETAIL_TYPE;
        case 1:
...
export function orderDetailTypeToJSON(object) {
    switch (object) {
        case OrderDetailType.NOT_USED_ORDER_DETAIL_TYPE:
            return "NOT_USED_ORDER_DETAIL_TYPE";
