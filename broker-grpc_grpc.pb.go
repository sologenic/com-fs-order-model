...
func (c *brokerLogServiceClient) Create(ctx context.Context, in *BrokerOrderDetails, opts ...grpc.CallOption) (*Key, error) {
	...
	out := new(Key)
	err := c.cc.Invoke(ctx, BrokerLogService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *brokerLogServiceClient) SetLock(ctx context.Context, in *LockLogRecord, opts ...grpc.CallOption) (*BrokerOrderDetails, error) {
	...
	err := c.cc.Invoke(ctx, BrokerLogService_SetLock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *brokerLogServiceClient) GetAllUnprocessed(ctx context.Context, in *InstanceID, opts ...grpc.CallOption) (*BrokerOrderDetailsList, error) {
	...
	err := c.cc.Invoke(ctx, BrokerLogService_GetAllUnprocessed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *brokerLogServiceClient) GetLatest(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*BrokerOrderDetails, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BrokerOrderDetails)
	err := c.cc.Invoke(ctx, BrokerLogService_GetLatest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBrokerLogServiceServer should be embedded to have
...
func (UnimplementedBrokerLogServiceServer) GetAllUnprocessed(context.Context, *InstanceID) (*BrokerOrderDetailsList, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAllUnprocessed not implemented")
}
...
func (UnimplementedBrokerLogServiceServer) testEmbeddedByValue() {}
...
func RegisterBrokerLogServiceServer(s grpc.ServiceRegistrar, srv BrokerLogServiceServer) {
	// If the following call panics, it indicates UnimplementedBrokerLogServiceServer was
