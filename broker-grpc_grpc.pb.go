...
func (c *brokerLogServiceClient) GetAllUnprocessed(ctx context.Context, in *InstanceID, opts ...grpc.CallOption) (*BrokerOrderDetailsList, error) {
	...
	err := c.cc.Invoke(ctx, "/order.BrokerLogService/GetAllUnprocessed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *brokerLogServiceClient) GetLatest(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*BrokerOrderDetails, error) {
	out := new(BrokerOrderDetails)
	err := c.cc.Invoke(ctx, "/order.BrokerLogService/GetLatest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BrokerLogService_GetAllUnprocessed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/order.BrokerLogService/GetAllUnprocessed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BrokerLogService_GetLatest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/order.BrokerLogService/GetLatest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
