...
func (c *smartContractLogServiceClient) Create(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Key, error) {
	...
	out := new(Key)
	err := c.cc.Invoke(ctx, SmartContractLogService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smartContractLogServiceClient) SetLock(ctx context.Context, in *LockLogRecord, opts ...grpc.CallOption) (*Order, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Order)
	err := c.cc.Invoke(ctx, SmartContractLogService_SetLock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smartContractLogServiceClient) GetAllUnprocessed(ctx context.Context, in *InstanceID, opts ...grpc.CallOption) (*Orders, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Orders)
	err := c.cc.Invoke(ctx, SmartContractLogService_GetAllUnprocessed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smartContractLogServiceClient) GetLatest(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Order, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Order)
	err := c.cc.Invoke(ctx, SmartContractLogService_GetLatest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSmartContractLogServiceServer should be embedded to have
...
func (UnimplementedSmartContractLogServiceServer) testEmbeddedByValue() {}
...
func RegisterSmartContractLogServiceServer(s grpc.ServiceRegistrar, srv SmartContractLogServiceServer) {
	// If the following call panics, it indicates UnimplementedSmartContractLogServiceServer was
...
var SmartContractLogService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "smartcontractlog-grpc.proto",
}
