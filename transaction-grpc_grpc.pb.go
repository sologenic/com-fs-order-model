...
const (
	...
	TransactionService_UpdateInternalOrderState_FullMethodName = "/transaction.TransactionService/UpdateInternalOrderState"
)
...
func (c *transactionServiceClient) UpdateInternalOrderState(ctx context.Context, in *UpdateInternalOrderStateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, TransactionService_UpdateInternalOrderState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TransactionService_UpdateInternalOrderState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionService_UpdateInternalOrderState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
