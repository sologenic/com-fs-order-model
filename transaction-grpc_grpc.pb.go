...
const (
	...
	TransactionService_UpdateOrderStatusInBroker_FullMethodName = "/transaction.TransactionService/UpdateOrderStatusInBroker"
)
...
func (c *transactionServiceClient) UpdateOrderStatusInBroker(ctx context.Context, in *UpdateOrderStatusInBrokerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, TransactionService_UpdateOrderStatusInBroker_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TransactionService_UpdateOrderStatusInBroker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionService_UpdateOrderStatusInBroker_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
