...
const file_sologenic_com_fs_order_model_util_proto_rawDesc = "" +
	"\n" +
	"'sologenic/com-fs-order-model/util.proto\x12\x05order\x1a\x1fgoogle/protobuf/timestamp.proto\"\x84\x01\n" +
	"\vProcessInfo\x127\n" +
...
var (
	...
	file_sologenic_com_fs_order_model_util_proto_rawDescData []byte
)
...
func file_sologenic_com_fs_order_model_util_proto_rawDescGZIP() []byte {
	file_sologenic_com_fs_order_model_util_proto_rawDescOnce.Do(func() {
		file_sologenic_com_fs_order_model_util_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sologenic_com_fs_order_model_util_proto_rawDesc), len(file_sologenic_com_fs_order_model_util_proto_rawDesc)))
	})
...
var file_sologenic_com_fs_order_model_util_proto_goTypes = []any{
...
func file_sologenic_com_fs_order_model_util_proto_init() {
	...
	file_sologenic_com_fs_order_model_util_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sologenic_com_fs_order_model_util_proto_rawDesc), len(file_sologenic_com_fs_order_model_util_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
