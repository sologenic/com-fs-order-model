...
function createBaseAssetExtension(): AssetExtension {
  return { ExtensionCodeID: "", ExtensionContractAddress: "", ExtensionPreviousCodeIDs: [], ExtensionType: 0 };
}

export const AssetExtension = {
  encode(message: AssetExtension, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): AssetExtension {
    return {
      ...
      ExtensionContractAddress: isSet(object.ExtensionContractAddress)
        ...
        : "",
      ExtensionPreviousCodeIDs: globalThis.Array.isArray(object?.ExtensionPreviousCodeIDs)
        ? object.ExtensionPreviousCodeIDs.map((e: any) => globalThis.String(e))
        : [],
  ...
  toJSON(message: AssetExtension): unknown {
    ...
    if (message.ExtensionPreviousCodeIDs?.length) {
  ...
  create<I extends Exact<DeepPartial<AssetExtension>, I>>(base?: I): AssetExtension {
    return AssetExtension.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AssetExtension>, I>>(object: I): AssetExtension {
    const message = createBaseAssetExtension();
    message.ExtensionCodeID = object.ExtensionCodeID ?? "";
    message.ExtensionContractAddress = object.ExtensionContractAddress ?? "";
    message.ExtensionPreviousCodeIDs = object.ExtensionPreviousCodeIDs?.map((e) => e) || [];
